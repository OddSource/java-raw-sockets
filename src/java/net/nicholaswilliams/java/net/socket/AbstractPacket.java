/*
 * AbstractPacket.java from RawSockets modified Tuesday, June 28, 2011 13:45:00 CDT (-0500).
 *
...
import net.nicholaswilliams.java.net.socket.exception.FinalizedPacketException;
import net.nicholaswilliams.java.net.socket.exception.IllegalHopLimitException;
...
public abstract class AbstractPacket implements Packet
{
	 ...
	 * @return {@code true} if this packet is of source {@link net.nicholaswilliams.java.net.socket.Packet.Source#INCOMING} and setting the address is allowed, {@code false} if this packet is of source {@link net.nicholaswilliams.java.net.socket.Packet.Source#OUTGOING} and setting the address is not allowed.
	 * @throws FinalizedPacketException if this packet is of source {@link net.nicholaswilliams.java.net.socket.Packet.Source#INCOMING} and was finalized prior to the invocation of this method.
	 */
	@Override
