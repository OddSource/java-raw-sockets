/*
 * Constants.c from RawSockets modified Thursday, June 30, 2011 10:09:15 CDT (-0500).
 *
...
/*
 * Class: net_nicholaswilliams_java_net_socket_Constants
	...
	(JNIEnv *environment, jclass, jstring constantNameJstring)
{
	...
	else
	{
		...
		environment->ThrowNew(
			environment->FindClass("net/nicholaswilliams/java/net/socket/exception/SocketConstantNotDefinedException"),
			message.c_str()
